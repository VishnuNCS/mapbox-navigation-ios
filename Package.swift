...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "MapboxNavigationNative", url: "https://github.com/mapbox/mapbox-navigation-native-ios.git", from: "79.0.0"),
        .package(name: "MapboxMaps", url: "https://github.com/mapbox/mapbox-maps-ios.git", .branch("vesh93/integrate_core_telemetry")),
